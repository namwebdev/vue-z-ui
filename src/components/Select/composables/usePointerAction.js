...
export default function usePointer(props, context, dep) {
  ...
  const isPointed = (option) => {
    return (
      !!pointer.value &&
      pointer.value[valueProp.value] == option[valueProp.value]
    );
  };
  ...
  const adjustWrapperScrollToPointer = () => {
    let pointedOption = document
      .getElementById(id.value)
      .querySelector(`.is-pointed`);
    ...
    if (
      ...
      wrapper.scrollTop =
        pointedOption.offsetTop +
        pointedOption.offsetHeight -
